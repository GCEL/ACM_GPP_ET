...
global_output_NUE_half_Tair_plus1 = list(        units = units,
                                                  area = area,
...
# Now save the file
save(global_output_NUE_half_Tair_plus1, file="./outputs/global_1x1_degree_2001_2015_NUE_half_Tair_plus1.RData")
