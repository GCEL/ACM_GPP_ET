...
summary(lm((drivers$Evap-drivers$soilevap-drivers$wetevap)~mean_transpiration))
summary(lm(drivers$soilevap~mean_soilevaporation))
summary(lm(drivers$wetevap~mean_wetcanopyevap))

# bias
mean(drivers$GPP-mean_gpp)
mean((drivers$Evap-drivers$soilevap-drivers$wetevap)-mean_transpiration)
mean(drivers$soilevap-mean_soilevaporation)
mean(drivers$wetevap-mean_wetcanopyevap)

# rmse
sqrt(mean((drivers$GPP-mean_gpp)**2))
sqrt(mean(((drivers$Evap-drivers$soilevap-drivers$wetevap)-mean_transpiration)**2))
sqrt(mean((drivers$soilevap-mean_soilevaporation)**2))
sqrt(mean((drivers$wetevap-mean_wetcanopyevap)**2))
