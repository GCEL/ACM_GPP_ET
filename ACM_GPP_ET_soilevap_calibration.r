...
output_dim=7 ; nofluxes = 4 ; nopools = 1 ; nopars = 5 ; nos_iter = 1000
...
for (n in seq(1,dim(drivers)[1])) {
     ...
     parameters[5,] = seq(0.1,0.9,length.out=1000)
...
print(seq(0.1,0.9,length.out=1000)[which(mean_residual == min(mean_residual,na.rm=TRUE))])
plot(mean_residual ~ seq(0.1,0.9,length.out=1000))
